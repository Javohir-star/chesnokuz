...
@app.post("/users/create3/", response_model=UserCreateResponse)
async def user_create2(user_data: UserCreateRequest):
    user = {
        "id": random.randint(1, 10000),
        "name": user_data.name,
...
@app.post("/users/create4/", response_model=UserCreateResponse)
async def user_create2(user_data: UserCreateRequest):
    user = {
        "id": random.randint(1, 10000),
        "name": user_data.name,
